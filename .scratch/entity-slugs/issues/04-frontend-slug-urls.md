...
- [ ] Detail, edit, and nested routes for all four entities are slug-based
...
- [ ] Detail pages resolve the slug param via the by-slug contract and render the entity.
- [ ] Links, `router.push`, and breadcrumbs carry the slug, not the id.
- [ ] Old id-URLs redirect to the slug URL (or a friendly not-found).
- [ ] Existing E2E specs updated to drive slug URLs.
